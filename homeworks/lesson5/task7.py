...
d = {1: 'ООО', 2: 'ОАО', 3: 'ПАО', 4: 'ЗАО', 5: 'ООО', 6: 'ОПГ',}

with open("task7.txt", 'w') as fh:
    for o, t in d.items():
        p = round(randint(5000, 19000) / 100) * 100
        r = round(randint(5000, 19000) / 100) * 100
        fh.write(fh'firm_{o} {t} {p} {r}\n')
"""
